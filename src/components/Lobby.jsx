 ...
 * @param {string} props.item - The label for the information item
 ...
 * @param {Object} props - Component props
 * @param {string} props.letter - The letter for the column (B, I, N, G, O)
 * @param {number[]} props.numbers - Array of numbers for this column
 * @param {'red' | 'blue' | 'green' | 'orange' | 'violet'} props.color - Color theme for the column
 */
function BingoColumn({ letter, numbers, color }) {
  const colorClasses = {
 ...
 * @param {Object} props - Component props
 * @param {string} props.letter - The letter for the column (B, I, N, G, O)
 * @param {(number | string)[]} props.numbers - Array of numbers or strings for this column
 * @param {'red' | 'blue' | 'green' | 'orange' | 'violet'} props.color - Color theme for the column
 */
function CartelaColumn({ letter, numbers, color }) {
  const colorClasses = {
    red: 'bg-red-500 text-red-100',
    blue: 'bg-blue-500 text-blue-100',
    green: 'bg-green-500 text-green-100',
